...
<button type="button" class="wusb-ver" data-url="../firmware/firmware_wireless_dongle_v0.3.3.bin" data-name="firmware_wireless_dongle_v0.3.3.bin"><div class="wusb-ver__head"><span class="wusb-ver__tag">v0.3.3</span><span class="wusb-ver__badge wusb-ver__badge--latest">Latest</span></div><div class="wusb-ver__title">Licensed multi-device</div><div class="wusb-ver__desc">Pendant + AutoDustBoot + Smart RGB LED on the same Wireless USB. App-only update that keeps your activation. A Wireless USB must be activated with your Installation ID in ncSender before it will relay.</div></button>
</div>

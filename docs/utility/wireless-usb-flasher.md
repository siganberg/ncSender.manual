...
<button type="button" class="wusb-ver" data-url="../firmware/firmware_wireless_usb_v0.2.2.bin" data-name="firmware_wireless_usb_v0.2.2.bin"><div class="wusb-ver__head"><span class="wusb-ver__tag">v0.2.2</span><span class="wusb-ver__badge wusb-ver__badge--latest">Latest</span></div><div class="wusb-ver__title">Multi-device support</div><div class="wusb-ver__desc">Pendant + AutoDustBoot + Smart RGB LED on the same Wireless USB. Requires ncSender v2.0.63+ or ncSender Pro v2.0.117+.</div></button>
